...
export const projects: IProject[] = [
	...
	},
	{
		...
		details:
			'Supervised fine-tuned and evaluated LLaDA diffusion model for Thai summarization against SOTA LLMs via DeepEval.',
		url: 'https://github.com/pupipatsk/NanoLLaDA'
	},
	{
		name: 'Chess Move Detection using Transfer Learning with CNN',
		details:
			'Engineered CV pipeline (96.94% accuracy) for chess video-to-notation via fine-tuning ResNet/InceptionV3.',
		url: 'https://github.com/athensclub/chess-video-move-detection'
	},
	{
		name: 'Stock Return Forecasting with Portfolio Optimization',
		details:
			'Forecasted S&P 500 returns (42.52% YoY) via various ML models and portfolio optimization techniques.',
	...
	},
	{
		...
		details: 'Developed workshop reservation system (9k+ users) via Next.js/Firestore.',
		url: 'https://github.com/esc-chula/intania-openhouse-2024/',
		hide: true
	},
	{
		name: 'Soul Seasons',
		details: 'Built interactive exhibition site (5k+ users) via Next.js/Framer Motion.',
		url: 'https://github.com/CBC-soul-seasons/soul-seasons',
		hide: true
	},
	{
		name: 'E-learning Website',
		details: 'Developed e-learning backend via NestJS, Prisma, and Google Cloud Run.',
		url: 'https://github.com/thinc-org/hacktoschool-fryingchicken',
		hide: true
	},
	{
		name: 'GFinder',
		details: 'Researched math model for Tennis GOAT identification via Python/Pandas (IMMC 2021).',
		url: 'https://github.com/Nacnano/IMMC-2021',
		hide: true
	},
	{
		name: 'MWIT29 Archive',
		details: 'Built school archive via Next.js, MongoDB, and Cloud Storage.',
