...
export const achievements: IAchievement[] = [
	{
		...
		details:
			'Won 1st place and a 50,000 Baht prize by designing and developing a web application that facilitates job matching for youth. Develop the frontend and OCR backend service using Next.js and Flask API.'
	},
	{
