...
export const technologies: ITechnology[] = [
	...
	},
	{
		...
		details: [
			{ text: 'Pandas', hide: false },
			{ text: 'NumPy', hide: false },
			{ text: 'Scikit-learn', hide: false },
			{ text: 'TensorFlow', hide: false },
...

	{
		...
		details: [
			...
			{ text: 'Apache Airflow', hide: false },
			{ text: 'MLflow', hide: false },
			{ text: 'PySpark', hide: false },
			{ text: 'Kafka', hide: false }
		]
	},
	{
		section: 'Services:',
